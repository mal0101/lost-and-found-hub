...
if (!isset($_SESSION['user_id'])) {
    set_flash_message('error', 'You must be logged in to report a lost item');
...
<div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
    ...
    <form action="<?php echo url('pages/items/report_lost_item.php'); ?>" method="post" enctype="multipart/form-data">
        <div class="mb-4">
