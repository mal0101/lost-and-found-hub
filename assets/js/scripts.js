...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (passwordInput) {
    passwordInput.addEventListener("input", function () {
      ...
      if (password.length === 0) {
        ...
        strengthIndicator.innerHTML =
          '<span class="text-red-500 text-sm">Weak password</span>';
      } else if (strength < 5) {
        strengthIndicator.innerHTML =
          '<span class="text-yellow-500 text-sm">Moderate password</span>';
      } else {
        strengthIndicator.innerHTML =
          '<span class="text-green-500 text-sm">Strong password</span>';
      }
    });
  }
  ...
  window.addEventListener("scroll", () => {
    if (window.scrollY > 10) {
      ...
      mainHeader.classList.add("opacity-80");
    } else {
      mainHeader.classList.remove("opacity-80");
